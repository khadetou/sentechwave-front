...
import orderService, { updatePaid } from "./oderService";
  ...
  extraReducers: (builder: any) => {
    builder
      .addCase(HYDRATE, (state: any, action: any) => {
        ...
        state.isError = action.payload.order.isError;
        state.isLoading = action.payload.order.isLoading;
        state.isSuccess = action.payload.order.isSuccess;
        state.message = action.payload.order.message;
      })
